...
Commands:
  ...
  deploy         Shortcut for ham up, then ham os and ham config.
...
@hamtask("""
usage: ham os [--reconfigure] [-t TAGS | --tags=TAGS] [-vv|-s|--silent]
